      ...
      <div class="container">
        ...
        <div class="text-center">
            @if ($project->cover_image)
                <img class="w-75" src="{{ asset('storage/' . $project->cover_image) }}" alt="{{ 'Cover image di ' . $project->title }}">
            @else
                <div class=" py-4 text-center d-inline-block">
                  <img class="w-75" src="{{Vite::asset('resources/img/dark-placeholder.png')}}" alt="Img unavailable">
